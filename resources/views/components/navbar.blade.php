<header class="bg-black/30 backdrop-blur-md sticky top-0 z-50">
    <nav class="max-w-7xl mx-auto flex justify-between items-center px-6 py-4">
        ...
        <div class="hidden md:flex items-center gap-8 font-bold text-sm">
            ...
            <div class="flex items-center gap-4">
                @auth
                    <!-- User Dropdown -->
                    <div class="relative">
                        <button id="user-dropdown-btn" class="flex items-center gap-2 bg-yellow-400 text-black px-4 py-2 rounded-lg font-bold hover:bg-yellow-300 transition">
                        ...
                        <!-- Dropdown Menu -->
                        <div id="user-dropdown-menu" class="absolute right-0 mt-2 w-48 bg-black/95 rounded-lg shadow-lg hidden flex-col py-2 z-50">
                            <a href="/profile" class="px-4 py-2 hover:bg-yellow-400 hover:text-black transition flex items-center gap-2">
                            ...
                            <form method="POST" action="/logout" class="px-4 py-2 hover:bg-yellow-400 hover:text-black transition">
                                @csrf
        ...
        <!-- Mobile Menu -->
        <div id="mobile-menu"
             class="absolute top-full left-0 right-0 bg-black/95 md:hidden hidden w-full">

            <nav class="flex flex-col gap-0 w-full border-b border-yellow-400/20">
                <a href="/" class="block py-3 px-4 hover:bg-yellow-400 hover:text-black transition border-b border-yellow-400/20">HOME</a>
                <a href="/menu" class="block py-3 px-4 hover:bg-yellow-400 hover:text-black transition border-b border-yellow-400/20">MENU</a>
                <a href="/reservation" class="block py-3 px-4 hover:bg-yellow-400 hover:text-black transition">BOOKING</a>
            </nav>
            ...
            <div class="flex flex-col w-full gap-0 py-4 px-4">
                @auth
                    ...
                    <button id="mobile-user-dropdown-btn" class="w-full flex items-center justify-between gap-2 bg-yellow-400 text-black px-4 py-3 rounded-lg font-bold hover:bg-yellow-300 transition mb-2">
                        ...
                        <svg id="mobile-dropdown-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                        </svg>
                    </button>

                    <!-- Mobile User Dropdown Menu -->
                    <div id="mobile-user-dropdown-menu" class="hidden flex-col gap-0 bg-black/50 rounded-lg overflow-hidden mb-2">
                        <a href="/profile" class="block py-3 px-4 hover:bg-yellow-400 hover:text-black transition flex items-center gap-2 border-b border-yellow-400/20">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                            </svg>
                            Profile
                        ...
                        <form method="POST" action="/logout">
                            @csrf
                            <button type="submit" class="w-full text-left py-3 px-4 hover:bg-yellow-400 hover:text-black transition flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                                </svg>
                                Logout
