...
<div class="min-h-screen bg-gray-100">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-8 mb-6">
            ...
            <!-- Customer Info -->
                <div class="grid grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-lg">{{ $order->user?->email ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <p class="text-gray-500 text-sm">Phone</p>
                        <p class="text-lg">{{ $order->user?->customer?->phone ?? '-' }}</p>
                    </div>
                    <div>
            ...
            <!-- Order Items -->
            <div class="mb-6">
                <h3 class="text-lg font-bold mb-3">Item Order</h3>
                <div class="bg-gray-50 rounded p-4">
                    @foreach ($order->orderItems as $item)
                        <div class="flex justify-between items-center mb-3 pb-3 border-b last:border-b-0 last:mb-0">
                            <div>
                                <p class="font-bold">{{ $item->menuItem->name }}</p>
            ...
            <div class="mb-6 p-4 bg-blue-50 rounded">
                ...
                <p class="text-3xl font-bold">Rp {{ number_format($order->total_price) }}</p>
            </div>
            ...
            @if ($order->notes)
                <div class="mb-6">
                    ...
                    <p class="p-3 bg-gray-50 rounded">{{ $order->notes }}</p>
                </div>
            @endif

            <!-- Status Update -->
            <div class="mb-6">
                <h3 class="text-lg font-bold mb-3">Ubah Status Order</h3>
            ...
            <div class="border-t pt-6">
                ...
                <p class="text-sm text-gray-500">Diupdate: {{ $order->updated_at->format('d-m-Y H:i') }}</p>
            </div>
        </div>
    </div>
</div>
