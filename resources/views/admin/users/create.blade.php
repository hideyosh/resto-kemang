        ...
        <div class="bg-white rounded-lg shadow p-8">
            ...
            <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                ...
                <div class="flex gap-4">
                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded font-bold transition">
                        Simpan User
                    </button>
                    <a href="{{ route('admin.users.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-2 rounded font-bold transition">
                        Batal
                    </a>
                </div>
            </form>
