        ...
        <div class="max-w-2xl mx-auto px-4 py-8">
            ...
            <div class="bg-white rounded-lg shadow p-8">
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="role" class="block text-sm font-medium mb-2 text-gray-800">
                            Role
                        </label>
                        <select name="role" id="role"
                            class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 hover:border-gray-400 transition">
