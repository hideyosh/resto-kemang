...
@section('title', 'Create Menu Item - Resto Kemang')

@section('content')
<section class="py-12 px-4">
    <div class="max-w-2xl mx-auto">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold mb-4">Create New Menu Item</h1>
            <p class="text-gray-400">Add a new dish to our menu</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="wagyu" {{ old('category') === 'wagyu' ? 'selected' : '' }}>Wagyu</option>
