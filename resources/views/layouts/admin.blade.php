...
<head>
  ...
  <title>@yield('title', 'Admin Dashboard') | Resto Kemang</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('admin.dashboard') }}" class="brand-link">
      <span class="brand-text font-weight-light pl-3">Resto Kemang Admin</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; {{ date('Y') }} <a href="#">Resto Kemang</a>.</strong> All rights reserved.
  </footer>
